...
public interface DeviceMapper {
    ...
    @Mapping(target = "name", source = "newDeviceDto.name")
    Device toDevice(User user, NewDeviceDto newDeviceDto);

    NewDeviceDto toNewDeviceDto(RegistrationStatusDto registrationStatusDto);
}
